...
namespace Postgres_1.ProductsAndStores
{
    public partial class ExtensionProperty
    {
        public ExtensionProperty()
        {
            ...
            InverseParentExtensionProperty = new HashSet<ExtensionProperty>();
        }
        ...
        public virtual ExtensionProperty ParentExtensionProperty { get; set; }
        public virtual ICollection<ExtensionPropertySchema> ExtensionPropertySchema { get; set; }
        public virtual ICollection<ExtensionProperty> InverseParentExtensionProperty { get; set; }
    }
}
